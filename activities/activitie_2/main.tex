...
As evidências foram organizadas em quatro dimensões: implementação, funcionamento da infraestrutura, desempenho agronômico e limitações. As fontes foram consultadas em 7 de setembro de 2026. Os resultados numéricos são dos pesquisadores citados, não dos autores desta atividade. As recomendações finais são inferências de projeto e não melhorias validadas experimentalmente.
