...
Uma RSSF é formada por vários nós sensores capazes de medir uma grandeza física, processar uma leitura e enviá-la por rádio. No estacionamento, a grandeza de interesse é a ocupação da vaga. O dado pode ser representado de maneira simples como $não-ocupada = 0$ ou $ocupada = 1$, acompanhado do identificador da vaga e do horário da medição. Essa organização permite distribuir a detecção e concentrar as leituras em um gateway conectado ao serviço de informação \cite{bagula2015,hilmani2018}.
